...
& candle.exe windows/wix/vasmm68k.wxs -o "${BUILD_RESULTS_DIR}/temp/vasmm68k.wixobj" -arch x64 "-dApplicationVersion=${VASM_PACKAGE_VERSION}"; if ($LASTEXITCODE -ne 0) { throw }

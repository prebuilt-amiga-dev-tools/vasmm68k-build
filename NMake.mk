...
package:
	...
	powershell -Command "$$ErrorActionPreference = 'Stop'; Compress-Archive -Path '$(BUILD_RESULTS_DIR)/vasmm68k_mot.exe', '$(BUILD_RESULTS_DIR)/vasmm68k_std.exe', '$(BUILD_RESULTS_DIR)/vobjdump.exe' -DestinationPath $(BUILD_RESULTS_DIR)/windows-binaries.zip; Remove-Item -Force $(BUILD_RESULTS_DIR)/vasmm68k_mot.exe; Remove-Item -Force $(BUILD_RESULTS_DIR)/vasmm68k_std.exe; Remove-Item -Force $(BUILD_RESULTS_DIR)/vobjdump.exe"
